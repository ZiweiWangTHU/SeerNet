...
class QResNet(nn.Module):
    ...
    def __init__(
        ...
        self.fc = QLinear(512 * block.expansion, num_classes,a_bit=8)
...
def qresnet18(pretrained=False,num_classes=1000):
    ...
    if pretrained:
        ...
        ch=torch.hub.load_state_dict_from_url(path)
        model.load_state_dict(ch,strict=False)
    return model

def qresnet50(pretrained=False,num_classes=1000):

    model=QResNet(block=Bottleneck,layers=[3,4,6,3],num_classes=num_classes)
